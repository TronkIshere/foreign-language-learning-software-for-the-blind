...
class AlphabetExercisePage extends StatefulWidget {
  final String jsonPath;
  const AlphabetExercisePage({super.key, required this.jsonPath});

  @override
  State<AlphabetExercisePage> createState() => _AlphabetExercisePageState();
}

class _AlphabetExercisePageState extends State<AlphabetExercisePage> {
