...
import 'package:GreenHexagon/features/basic_vocabulary/basic_vocabulary_lesson/widgets/lesson_grid.dart';
import 'package:GreenHexagon/features/basic_vocabulary/unit/widgets/pagination_row.dart';
import 'package:flutter/material.dart';
import 'package:flutter/services.dart' show rootBundle;

class BasicVocabularyLessonPage extends StatefulWidget {
  final String jsonPath;
  const BasicVocabularyLessonPage({super.key, required this.jsonPath});

  @override
  State<BasicVocabularyLessonPage> createState() => _BasicVocabularyLessonPageState();
}

class _BasicVocabularyLessonPageState extends State<BasicVocabularyLessonPage> {
